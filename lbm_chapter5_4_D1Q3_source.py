...
class lbm_solver:
    ...
    def collision(self):
        for i in range(self.m):
            ...
            self.f[i][0] = (1-self.omega)*self.f[i][0]+self.omega*feq0 + self.qsr*self.w[0]
            self.f[i][1] = (1-self.omega)*self.f[i][1]+self.omega*feq+ self.qsr*self.w[1]
            self.f[i][2] = (1-self.omega)*self.f[i][2]+self.omega*feq+ self.qsr*self.w[2]
